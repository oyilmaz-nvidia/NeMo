...
def get_infer_test_data():
    ...
    test_data["LLAMA2-13B-base-int4"]["checkpoint"] = "/opt/checkpoints/LLAMA2-13B-base-int4/LLAMA2-13B-base-int4-1-qnemo"
    ...
    test_data["LLAMA2-70B-base-int4"]["checkpoint"] = "/opt/checkpoints/LLAMA2-70B-base-int4/LLAMA2-70B-base-int4-1-qnemo"
